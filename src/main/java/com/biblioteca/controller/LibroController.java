 ...
 *
 * @RestController  → combina @Controller + @ResponseBody: todos los métodos retornan JSON
 * @RequestMapping  → URL base para todos los endpoints de este controlador
 *
 * Endpoints:
 *   POST   /api/libros        → Crear un nuevo libro        (201 Created)
 *   GET    /api/libros        → Listar todos los libros     (200 OK)
 *   GET    /api/libros/{id}   → Consultar un libro por ID   (200 OK)
